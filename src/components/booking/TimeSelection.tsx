...
export function TimeSelection({
  ...
  // Generate visible available dates (Saturdays + Sundays, next 60 days)
  useEffect(() => {
    const dates: Date[] = [];
    let date = startOfDay(new Date());
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-espresso-500 mb-4">
          Available <span className="font-medium text-espresso-700">Saturdays 10 AM–4 PM &amp; Sundays 10 AM–3 PM</span>. Questions?{' '}
